...
export const SKILLS_ORIGINAL = {
  ...
  "00002061": {  "name": "Training Bomb", "description": "10% chance blow enemy ammunition, and damage 3x(amount ammunition)"  },
  "00002062": {  "name": "Pre-emptive Attack", "description": "the first melee attack/defense +20%"  },
  "00002080": {  "name": "Improved Ram", "description": "increase ram attack power, can be increased with sail on Tailwind and Huge ram"  },
  "00002083": {  "name": "Set Fire", "description": "burn yourself with major fire and melee, 10% damage on both side"  },
  "00002101": {  "name": "Command Post", "description": "prevent the disorder from cannon shots"  },
  "00002102": {  "name": "Repair Support", "description": "+50% skill repair effect, for all fleet"  },
  "00002103": {  "name": "Intensive Repair", "description": "+100% skill repair when sail are being folded, the only for ship user"  },
...
export const SKILLS_GRADE = {
  "00004000": {"name": "Durability Improvement","description": "Improves ship is durability"  },
  "00004001": {"name": "Vertical Sail Improvement","description": "Improves ship is vertical sails"  },
  "00004002": {"name": "Horizontal Sail Improvement","description": "Improves ship is horizontal sails"  },
  "00004003": {"name": "Improve Sail Speed","description": "Improves ship is rowing stats"  },
  "00004004": {"name": "Turn Speed Improvement","description": "Improves ship is turn speed stats"  },
  "00004005": {"name": "Wave Resistance Improvement","description": "Improves ship is wave resist stats"  },
  "00004006": {"name": "Armour Improvement","description": "Improves ship is armour stat"  },
  "00004007": {"name": "Cabin Capacity Improvement","description": "Improves ship is maximum crew stat"  },
  "00004008": {"name": "Cannon Chambers Capacity Improvement","description": "Improves ship is maximum cannon stat"  },
  "00004009": {"name": "Cargo Hold Capacity Improvement ","description": "Improves ship is maximum cargo stat"  },
  "00004010": {"name": "Broadside Addition","description": "This bonus will add another broadside cannon slot"  },
  "00004011": {"name": "Bow Turret Addition","description": "This bonus will add a bow turret slot to your ship"  },
  "00004012": {"name": "Skill Slot Addition 1","description": "This bonus will add third skill slot to your ship"  },
  "00004013": {"name": "Skill Slot Addition 2","description": "This bonus will add fourth skill slot to your ship"  },
  "00004014": {"name": "Gunboat Refit","description": "+5% increase in cannon damage, but it makes the ship 5% more vulnerable to cannon damage, and increased damage from melee"  },
  "00004015": {"name": "Armoured Ship Refit","description": "+5% increase in cannon damage, but it reduces max speed and turning speed"  },
  "00004016": {"name": "Melee Battle Ship Refit","description": "increase in melee damage and reduces melee damage received, but it increases damage done by cannon shots by 5%"  },
  "00004017": {"name": "Expedition Ship Refit","description": "makes you obtain 10% more adventure XP while making discoveries at sea, it also greatly increases the rate at which shipwrecks rise, and it reduces the durability damage you take while raising a shipwreck"  },
  "00004018": {"name": "Ship Speed Up I","description": "5% increase both acceleration and battle"  },
  "00004019": {"name": "Ship Speed Up II","description": "10% increase both acceleration and battle"  },
  "00004020": {"name": "Ship Speed Up III","description": "15% increase both acceleration and battle"  },
  "00004021": {"name": "Skill inheritance","description": "skills on the material ship that can be inherited are indicated with a star"  }
}
